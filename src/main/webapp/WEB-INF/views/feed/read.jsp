		...
		<div class="left_container">
			<div id="left_nav" class="sidenav" style="width: 50px;"
				...
				<c:when test="${not empty sessionScope.id }">
				  	...
				  	<a href="/feed/read" class="tip">Friend Feed<span>전체/친구 공개의 게시물을 확인하기</span></a>
				  	<a href="/searching" class="tip">Searching Map<span>전국 지도 위에서 게시물 찾기</span></a>
			  	</c:when>
			  	<c:otherwise>
				  	<a href="javascript:void(0)" onclick="onclick_login_open()" class="tip">My Feed<span>내 게시물을 확인하기</span></a>
				  	<a href="javascript:void(0)" onclick="onclick_login_open()" class="tip">Friend Feed<span>전체/친구 공개의 게시물을 확인하기</span></a>
				  	<a href="javascript:void(0)" onclick="onclick_login_open()" class="tip">Searching Map<span>전국 지도 위에서 게시물 찾기</span></a>
			  	</c:otherwise>
			  	</c:choose>
			</div>
		</div>
